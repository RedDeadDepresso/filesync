...
class BroadcastPromptDialog extends StatefulWidget {
  ...
  const BroadcastPromptDialog({super.key});
...
class _BroadcastPromptDialogState extends State<BroadcastPromptDialog> {
  ...
  TextEditingController name = TextEditingController(
    text: DefaultAppService.service.name,
  );

  /// Corresponds to _<this>_._tcp.
  TextEditingController type = TextEditingController(
    text: DefaultAppService.type,
  );
        ...
        onPressed: () => Navigator.pop(
          ...
          BonsoirService(
            ...
            attributes: attributes.map(
              (key, value) => MapEntry(key.text, value.text),
            ),
          ),
        ),
        child: Text('Ok'),
